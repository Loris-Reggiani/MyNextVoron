import {
  ...
  isBandScale,
  useTicks_default
} from "./chunk-S2EXIOA6.js";
import {
  useClassNamesOverride,
  useSlotProps
} from "./chunk-RAJLCEIN.js";
import {
  Typography_default
} from "./chunk-56AI7S7X.js";
import {
  createPopper
} from "./chunk-3BL7RAH3.js";
import "./chunk-FSIN542O.js";
import {
  useTheme
} from "./chunk-T33Z75I2.js";
import {
  Box_default
} from "./chunk-UO6O3BPG.js";
import {
  require_react_dom
...
import {
  ...
  useForkRef
} from "./chunk-ZXUPHRV5.js";
import "./chunk-P7B7ZO5Y.js";
import {
  clsx_default,
  composeClasses,
...
var useAxisEvents = (disableAxisListener) => {
  const svgRef = React4.useContext(SVGContext);
  const {
    width,
    height,
    top,
...
var HighlighContext = React6.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React6.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
...
var ChartContainer = React7.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
  ...
  const svgRef = React7.useRef(null);
  const handleRef = useForkRef(ref, svgRef);
  useReducedMotion2();
  return (0, import_jsx_runtime5.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime5.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime5.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime5.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime5.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime5.jsx)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
...
var useChartDimensions = (inWidth, inHeight) => {
  const rootRef = React8.useRef(null);
  const displayError = React8.useRef(false);
  const [width, setWidth] = React8.useState(0);
  const [height, setHeight] = React8.useState(0);
  const computeSize = React8.useCallback(() => {
...
var ResponsiveChartContainer = React8.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded2);
  const [containerRef, width, height] = useChartDimensions(inWidth, inHeight);
  return (0, import_jsx_runtime6.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime6.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
function ChartsText(props) {
  ...
  return (0, import_jsx_runtime7.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index) => (0, import_jsx_runtime7.jsx)("tspan", {
      x,
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React11.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React12.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
    ...
    children: [!disableLine && (0, import_jsx_runtime10.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime11.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime10.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && (0, import_jsx_runtime10.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
var Portal = React14.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React14.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React19.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React21.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React21.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React21.useMemo(() => {
...
function DefaultChartsLegend(props) {
  ...
  const seriesWithPosition = React24.useMemo(() => {
    let x = 0;
    let y = 0;
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React24.useContext(DrawingContext);
...
var useInteractionItemProps = (scope) => {
  ...
  } = React26.useContext(HighlighContext);
...
var _excluded8 = ["id", "dataIndex", "classes", "color", "highlightScope", "onClick", "isFaded", "isHighlighted", "startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius"];
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React28.useCallback((dataIndex) => {
  ...
  const dataWithHighlight = React28.useMemo(() => data.map((item, itemIndex) => {
...
var _excluded9 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onClick", "skipAnimation"];
var _excluded25 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "arcLabelRadius", "outerRadius", "cornerRadius"];
...
var _excluded11 = ["slots", "slotProps", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "arcLabel", "arcLabelMinAngle", "skipAnimation"];
...
function PiePlot(props) {
  ...
  const seriesData = React32.useContext(SeriesContext).pie;
  const {
    left,
    top,
    width,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime35.jsxs)(ResponsiveChartContainer, {
    ...
    children: [(0, import_jsx_runtime34.jsx)(ChartsAxis, {
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime34.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime34.jsx)(ChartsTooltip, _extends({}, tooltip)), children]
  });
}
true ? PieChart.propTypes = {
  ...
  series: import_prop_types21.default.arrayOf(import_prop_types21.default.shape({
    ...
    arcLabelRadius: import_prop_types21.default.oneOfType([import_prop_types21.default.number, import_prop_types21.default.string]),
    ...
    paddingAngle: import_prop_types21.default.number,
    sortingValues: import_prop_types21.default.oneOfType([import_prop_types21.default.oneOf(["asc", "desc", "none"]), import_prop_types21.default.func]),
    startAngle: import_prop_types21.default.number,
    type: import_prop_types21.default.oneOf(["pie"]),
